...
Meteor.Streamer = (function (_EV2) {                                                                                // 14
	...
	Streamer.prototype.iniPublication = (function () {                                                                 // 14
		function iniPublication() {                                                                                       // 205
			...
			Meteor.publish(this.subscriptionName, function (eventName, useCollection) {                                      // 207
				check(eventName, String);                                                                                       // 208
				check(useCollection, Match.Optional(Boolean));                                                                  // 209
                                                                                                                    //
				if (eventName.length === 0) {                                                                                   // 211
					this.stop();                                                                                                   // 212
					return;                                                                                                        // 213
				}                                                                                                               //
                                                                                                                    //
				if (stream.isReadAllowed(this, eventName) !== true) {                                                           // 216
					this.stop();                                                                                                   // 217
					return;                                                                                                        // 218
				}                                                                                                               //
                                                                                                                    //
				var subscription = {                                                                                            // 221
					subscription: this,                                                                                            // 222
					eventName: eventName                                                                                           // 223
				};                                                                                                              //
                                                                                                                    //
				stream.addSubscription(subscription, eventName);                                                                // 226
                                                                                                                    //
				this.onStop(function () {                                                                                       // 228
					stream.removeSubscription(subscription, eventName);                                                            // 229
				});                                                                                                             //
                                                                                                                    //
				if (useCollection === true) {                                                                                   // 232
					// Collection compatibility                                                                                    //
					this._session.sendAdded(stream.subscriptionName, 'id', {                                                       // 234
						eventName: eventName                                                                                          // 235
					});                                                                                                            //
				}                                                                                                               //
                                                                                                                    //
				this.ready();                                                                                                   // 239
	...
	Streamer.prototype.initMethod = (function () {                                                                     // 14
		function initMethod() {                                                                                           // 243
			var stream = this;                                                                                               // 244
			var method = {};                                                                                                 // 245
                                                                                                                    //
			method[this.subscriptionName] = function (eventName) {                                                           // 247
				for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {       //
					args[_key - 1] = arguments[_key];                                                                              // 247
				}                                                                                                               //
                                                                                                                    //
				check(eventName, String);                                                                                       // 248
				check(args, Array);                                                                                             // 249
                                                                                                                    //
				this.unblock();                                                                                                 // 251
                                                                                                                    //
				if (stream.isWriteAllowed(this, eventName, args) !== true) {                                                    // 253
					return;                                                                                                        // 254
				}                                                                                                               //
                                                                                                                    //
				var methodScope = {                                                                                             // 257
					userId: this.userId,                                                                                           // 258
					connection: this.connection,                                                                                   // 259
					originalParams: args,                                                                                          // 260
					tranformed: false                                                                                              // 261
				};                                                                                                              //
                                                                                                                    //
				args = stream.applyTransformers(methodScope, eventName, args);                                                  // 264
                                                                                                                    //
				stream.emitWithScope.apply(stream, [eventName, methodScope].concat(args));                                      // 266
                                                                                                                    //
				if (stream.retransmit === true) {                                                                               // 268
					stream._emit(eventName, args, this.connection, true);                                                          // 269
				}                                                                                                               //
			};                                                                                                               //
                                                                                                                    //
			try {                                                                                                            // 273
				Meteor.methods(method);                                                                                         // 274
			} catch (e) {                                                                                                    //
				console.error(e);                                                                                               // 276
			}                                                                                                                //
		}                                                                                                                 //
	...
	Streamer.prototype._emit = (function () {                                                                          // 14
		function _emit(eventName, args, origin, broadcast) {                                                              // 280
			var _this = this;                                                                                                //
                                                                                                                    //
			if (broadcast === true) {                                                                                        // 281
				Meteor.StreamerCentral.emit('broadcast', this.name, eventName, args);                                           // 282
			}                                                                                                                //
                                                                                                                    //
			var subscriptions = this.subscriptionsByEventName[eventName];                                                    // 285
			if (!Array.isArray(subscriptions)) {                                                                             // 286
				return;                                                                                                         // 287
			}                                                                                                                //
                                                                                                                    //
			subscriptions.forEach(function (subscription) {                                                                  // 290
				if (_this.retransmitToSelf === false && origin && origin === subscription.subscription.connection) {            // 291
					return;                                                                                                        // 292
				}                                                                                                               //
                                                                                                                    //
				subscription.subscription._session.sendChanged(_this.subscriptionName, 'id', {                                  // 295
					eventName: eventName,                                                                                          // 296
					args: args                                                                                                     // 297
				});                                                                                                             //
			});                                                                                                              //
		}                                                                                                                 //
	...
	Streamer.prototype.emit = (function () {                                                                           // 14
		function emit(eventName) {                                                                                        // 302
			for (var _len2 = arguments.length, args = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
				args[_key2 - 1] = arguments[_key2];                                                                             // 302
			}                                                                                                                //
                                                                                                                    //
			this._emit(eventName, args, undefined, true);                                                                    // 303
		}                                                                                                                 //
                                                                                                                    //
		return emit;                                                                                                      //
	})();                                                                                                              //
	...
	Streamer.prototype.emitWithoutBroadcast = (function () {                                                           // 14
		function emitWithoutBroadcast(eventName) {                                                                        // 306
			for (var _len3 = arguments.length, args = Array(_len3 > 1 ? _len3 - 1 : 0), _key3 = 1; _key3 < _len3; _key3++) {
				args[_key3 - 1] = arguments[_key3];                                                                             // 306
			}                                                                                                                //
                                                                                                                    //
			this._emit(eventName, args, undefined, false);                                                                   // 307
		}                                                                                                                 //
                                                                                                                    //
